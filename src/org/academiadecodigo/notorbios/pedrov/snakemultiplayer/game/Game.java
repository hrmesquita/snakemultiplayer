...
public class Game implements KeyboardHandler {
    ...
    private void moveSnakes(Direction tempDirectionP1, Direction tempDirectionP2) {
        if (System.currentTimeMillis() >= endTimeFrozenP1) {
            if (endTimeFrozenP1 != 0) {
                snakeP1.unfreeze();
                endTimeFrozenP1 = 0;
            }
        ...
        if (System.currentTimeMillis() >= endTimeFrozenP2) {
            if (endTimeFrozenP2 != 0) {
                snakeP2.unfreeze();
                endTimeFrozenP2 = 0;
            }
    ...
    public void keyPressed(KeyboardEvent keyboardEvent) {
        switch (keyboardEvent.getKey()) {
            ...
            case KeyboardEvent.KEY_LEFT:
                if (gameState == 1) {
                    if (Settings.isP1 && System.currentTimeMillis() >= endTimeFrozenP1) {
                        directionP1 = Direction.LEFT;
                    } else if (!Settings.isP1 && System.currentTimeMillis() >= endTimeFrozenP2) {
